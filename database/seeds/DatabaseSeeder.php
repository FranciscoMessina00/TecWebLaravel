...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('accomodations')->insert([
            ['accId' => 1, 'userId' => 2, 'name' => 'Appartamento Bella Vista', 'tipology' => 0,'city'=>'Ancona', 'address'=>'via tizio caio, 16', 'description'=>'Scritta di prova','dimBedroom'=>null,'dimAppartment'=>200,'rooms'=>6,'totBeds'=>2,'totBedRoom'=>1,'ageMax'=>25,'ageMin'=>20,'price'=>250,'state'=>true,'dateOffer'=>'2000-01-01','dateBooking'=>'2000-01-01','dateStart'=>'2022-09-01','dateFinish'=>'2023-09-01','created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['accId' => 2, 'userId' => 6, 'name' => 'Appartamento Brutta Vista', 'tipology' => 0,'city'=>'Firenze', 'address'=>'via tizio, 16','description'=>'Scritta di prova','dimBedroom'=>null,'dimAppartment'=>180,'rooms'=>5,'totBeds'=>2,'totBedRoom'=>1,'ageMax'=>25,'ageMin'=>20,'price'=>300,'state'=>true,'dateOffer'=>'2000-01-01','dateBooking'=>'2000-01-01','dateStart'=>'2022-09-15','dateFinish'=>'2022-12-08','created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['accId' => 3, 'userId' => 6, 'name' => 'Posto letto da Maria', 'tipology' => 1,'city'=>'Torino', 'address'=>'via caio, 16','description'=>'Scritta di prova','dimBedroom'=>12,'dimAppartment'=>null,'rooms'=>null,'totBeds'=>2,'totBedRoom'=>1,'ageMax'=>25,'ageMin'=>20,'price'=>200,'state'=>true,'dateOffer'=>'2000-01-01','dateBooking'=>'2000-01-01','dateStart'=>'2022-10-4','dateFinish'=>'2022-12-12','created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['accId' => 4, 'userId' => 6, 'name' => 'Appartamento Tavernelle', 'tipology' => 0,'city'=>'Milano', 'address'=>'via tizio caio, 16','description'=>'Scritta di prova','dimBedroom'=>null,'dimAppartment'=>200,'rooms'=>4,'totBeds'=>2,'totBedRoom'=>1,'ageMax'=>25,'ageMin'=>20,'price'=>200,'state'=>true,'dateOffer'=>'2000-01-01','dateBooking'=>'2000-01-01','dateStart'=>'2022-09-21','dateFinish'=>'2023-02-28','created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['accId' => 5, 'userId' => 2, 'name' => "Appartamento Monte D'Ago", 'tipology' => 0,'city'=>'Ancona', 'address'=>'via tizio, 16','description'=>'Scritta di prova','dimBedroom'=>null,'dimAppartment'=>220,'rooms'=>3,'totBeds'=>2,'totBedRoom'=>1,'ageMax'=>25,'ageMin'=>20,'price'=>400,'state'=>true,'dateOffer'=>'2000-01-01','dateBooking'=>'2000-01-01','dateStart'=>'2022-10-01','dateFinish'=>'2023-08-01','created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['accId' => 6, 'userId' => 2, 'name' => 'Posto letto Grazie', 'tipology' => 1,'city'=>'Napoli', 'address'=>'via caio, 16','description'=>'Scritta di prova','dimBedroom'=>23,'dimAppartment'=>null,'rooms'=>null,'totBeds'=>2,'totBedRoom'=>1,'ageMax'=>25,'ageMin'=>20,'price'=>500,'state'=>true,'dateOffer'=>'2000-01-01','dateBooking'=>'2000-01-01','dateStart'=>'2022-08-01','dateFinish'=>'2023-08-01','created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')]
        ]);
