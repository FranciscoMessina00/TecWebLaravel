...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('accomodations')->insert([
            ['accId' => 1, 'userId' => 2, 'imageId' => 2, 'name' => 'Appartamento Bella Vista', 'tipology' => 0,'city'=>'Ancona', 'address'=>'via tizio caio, 16', 'description'=>'Scritta di prova','dimBedroom'=>null,'dimAppartment'=>200,'rooms'=>6,'totBeds'=>2,'totBedRoom'=>1,'ageMax'=>25,'ageMin'=>20,'price'=>250, 'gender' => 'uomo' , 'dateOffer'=>date('Y-m-d H:i:s'),'dateStart'=>'2022-09-01','dateFinish'=>'2023-09-01','created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['accId' => 2, 'userId' => 6, 'imageId' => 3, 'name' => 'Appartamento Brutta Vista', 'tipology' => 0,'city'=>'Firenze', 'address'=>'via tizio, 16','description'=>'Scritta di prova','dimBedroom'=>null,'dimAppartment'=>180,'rooms'=>5,'totBeds'=>2,'totBedRoom'=>1,'ageMax'=>25,'ageMin'=>20,'price'=>300, 'gender' => 'donna' , 'dateOffer'=>date('Y-m-d H:i:s'),'dateStart'=>'2022-09-15','dateFinish'=>'2022-12-08','created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
