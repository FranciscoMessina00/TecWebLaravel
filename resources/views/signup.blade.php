            ...
            <div class="container-small auto-margin-lr pad-lr-large">
                ...
                <form name="accedi" method="get" class="">
                    ...
                    <div>
                        ...
                        <div class="margin-b-40">
                            <input class="form-element" id="nome" type="text" name="nome" placeholder="Inserisci nome">
                        </div>
                    </div>
                    <div>
                        <div class="text-left">
                        ...
                        <div class="margin-b-40">
                            <input class="form-element" id="cognome" type="text" name="cognome" placeholder="Inserisci cognome">
                        </div>
                    </div>
                    <div>
                        <div class="text-left">
